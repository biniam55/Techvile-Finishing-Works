    ...
    <section className="rectangle-parent9">
      ...
      <div className="parameter-processor">
        <div className="control-center">
          <div className="transition-triggler-parent">
            <div className="transition-triggler">
              <div className="our-company3">Our Company</div>
            </div>
            <div className="connection-controller">
              <div className="signal-sender">
                <div className="testimonials6">Testimonials</div>
              </div>
          ...
          <div className="error-eliminator">
            <div className="performance-tracker">
              ...
              <div className="signal-router">
                <img
                  className="condition-combiner-icon"
                  alt=""
                  src="/frame.svg"
                />
                <img
                  className="sequence-sequencer-icon"
                  loading="lazy"
                  alt=""
                  src="/vector-21.svg"
                />
      ...
      <div className="data-distributor" />
      <div className="copyright-2024-fyn-finishing-container">
